...
MAPPINGS = {
    "GHL_API_KEY":           ("https://mcp.gohighlevel.com",            "static_bearer", "GoHighLevel"),
    "GHL_PIT_TOKEN":         ("https://mcp.gohighlevel.com",            "static_bearer", "GoHighLevel PIT"),
    ...
    "N8N_API_KEY":           ("https://<your-n8n-domain>/mcp",       "static_bearer", "n8n"),
